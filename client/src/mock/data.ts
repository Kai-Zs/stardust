...
export const mockProjects = [
  ...
  { id: 3, name: '工具脚本集', description: '日常使用的 Python/Shell 脚本集合', tech_stack: ['Python', 'Shell'], github_url: 'https://github.com/Kai-Zs/scripts', homepage_url: null, featured: false },
]
...
export const mockTimeline = [
  ...
  { id: 4, title: '搭建第一台服务器', description: '购买云服务器，学习 Linux 基础运维', date: '2026-01', icon: '💻' },
]
...
export const mockComments: MockComment[] = [
  { id: 1, post_id: 1, parent_id: null, nickname: '小明', content: '写得真好，期待更多文章！', ip_location: '北京', created_at: '2026-04-28 12:00' },
  { id: 2, post_id: 1, parent_id: 1, nickname: '博主', content: '谢谢支持！', ip_location: '上海', created_at: '2026-04-28 12:30' },
]
